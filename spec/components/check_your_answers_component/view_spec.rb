...
RSpec.describe CheckYourAnswersComponent::View, type: :component do
  ...
  let(:steps) do
    [
      build(:step, question: question, form_document_step: build(:question_step, :with_text_settings)),
      build(:step, question: optional_question, form_document_step: build(:question_step, :with_text_settings)),
    ]
  end
  ...
  context "when a step is repeatable and has an answer" do
    let(:steps) { [build(:repeatable_step, question: question, form_document_step: build(:question_step, :with_text_settings))] }
