...
RSpec.describe Question::TextComponent::View, type: :component do
  let(:form_document_step) { build :question_step, :with_text_settings, input_type: }
  ...
  describe "when component is short answer text field" do
    ...
    context "when the question has hint text" do
      let(:form_document_step) { build :question_step, :with_hints, :with_text_settings, input_type: }
    ...
    context "with unsafe question text" do
      let(:form_document_step) { build :question_step, :with_text_settings, input_type:, question_text: "What is your name? <script>alert(\"Hi\")</script>" }
      let(:mode) { Mode.new("preview-draft") }
    ...
    context "when question has guidance" do
      let(:form_document_step) { build :question_step, :with_text_settings, :with_guidance, input_type: }
