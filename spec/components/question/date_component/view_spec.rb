...
RSpec.describe Question::DateComponent::View, type: :component do
  let(:form_document_step) { build :question_step, :with_date_settings, input_type: }
  ...
  describe "when component is other date field" do
    ...
    context "when the question has hint text" do
      let(:form_document_step) { build :question_step, :with_hints, :with_date_settings, input_type: }
    ...
    context "with unsafe question text" do
      let(:form_document_step) { build :question_step, :with_date_settings, input_type:, question_text: "What is your name? <script>alert(\"Hi\")</script>" }
      let(:mode) { Mode.new("preview-draft") }
    ...
    context "when question has guidance" do
      let(:form_document_step) { build :question_step, :with_guidance, :with_date_settings }
  ...
  context "when answer_settings is nil - behaves like other dates" do
    ...
    context "when question has guidance" do
      let(:form_document_step) { build :question_step, :with_guidance, answer_type: "date", answer_settings: }
