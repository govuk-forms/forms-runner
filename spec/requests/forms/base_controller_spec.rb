...
RSpec.describe Forms::BaseController, type: :request do
  ...
  describe "#error_repeat_submission" do
    ...
    it "renders the page with a link back to the form start page" do
      expect(response.body).to include(form_page_path(mode: "form", form_id: 2, form_slug: form_response_data.form_slug, step_slug: 1))
    end
  end
    ...
    context "with preview mode on" do
        ...
        context "when a form exists" do
          ...
          context "when the form has a start page" do
            it "Redirects to the first page" do
              expect(response).to redirect_to(form_page_path(mode: "preview-draft", form_id: 2, form_slug: form_response_data.form_slug, step_slug: 1))
            end
      ...
      context "with a live form" do
        ...
        context "when a form exists" do
          ...
          context "when the form has a start page" do
            it "Redirects to the first page" do
              expect(response).to redirect_to(form_page_path(mode: "preview-live", form_id: 2, form_slug: form_response_data.form_slug, step_slug: 1))
            end
    ...
    context "with preview mode off" do
      context "when a form is live" do
        context "when a form exists" do
          ...
          context "when the form has a start page" do
            it "Redirects to the first page" do
              expect(response).to redirect_to(form_page_path(mode: "form", form_id: 2, form_slug: form_response_data.form_slug, step_slug: 1))
            end
  ...
  describe "locale" do
    ...
    context "when getting a form page that exists" do
      before do
        get form_page_path(mode: "form", form_id: 2, form_slug: form_response_data.form_slug, step_slug: 1, locale:)
      end
