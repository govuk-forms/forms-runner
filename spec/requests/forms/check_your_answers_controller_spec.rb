    ...
    context "when user has requested a confirmation email" do
      ...
      it "sends a confirmation email" do
        ...
        expected_personalisation = {
          ...
          support_contact_details: contact_support_details_format.html_safe.squish,
        ...
        expect(mail.html_part.decoded.squish).to include(expected_personalisation[:support_contact_details])
...
private
  ...
  def contact_support_details_format
    phone_number = "<p>#{form_data.support_phone}</p>\n<p><a href=\"https://www.gov.uk/call-charges\">#{I18n.t('support_details.call_charges')}</a></p>"
    email = "<p><a href=\"mailto:#{form_data.support_email}\">#{form_data.support_email}</a></p>"
    online = "<p><a href=\"#{form_data.support_url}\">#{form_data.support_url_text}</a></p>"
