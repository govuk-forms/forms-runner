...
RSpec.describe ErrorsController, type: :request do
  ...
  describe "Submission error" do
    ...
    before do
      ...
      get form_page_path(mode: "form", form_id: 2, form_slug: "form-name", step_slug: 1)
      post save_form_page_path(mode: "form", form_id: 2, form_slug: "form-name", step_slug: 1, question: { text: "test" })
