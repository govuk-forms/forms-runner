...
RSpec.describe SendSubmissionBatchJob, type: :job do
  ...
  let(:form_document) { build(:form_document, :with_steps, name: "My Form", submission_email:) }
  ...
  context "when there are submissions" do
    ...
    context "when the form settings have changed between submissions" do
      let(:new_form_document) { build(:form_document, :with_steps, name: "New form name", submission_email: "new-email@example.gov.uk") }
      let(:submissions) do
        [
